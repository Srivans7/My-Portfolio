...
export default class Application
{
    ...
    setRenderer()
    {
        ...
        // Use modern Three.js color management API
        this.renderer.physicallyCorrectLights = true
    ...
    setThreejsJourney()
    {
        // Only instantiate ThreejsJourney if its container exists in the DOM
        if (document.querySelector('.js-threejs-journey')) {
            ...
            // Avoid noisy console warning from ThreejsJourney constructor when element is absent
            this.threejsJourney = null
        }
    }
