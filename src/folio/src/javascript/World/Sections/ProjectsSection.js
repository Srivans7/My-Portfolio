        ...
        this.list = [
            {
                ...
                link:
                {
                    href: 'https://github.com/Srivans7/Welth',
                    x: - 4.8,
                    y: - 3,
                    halfExtents:
                    {
            ...
            },
            {
                ...
                link:
                {
                    href: 'https://github.com/Srivans7/eVoting-DApp',
                    x: - 4.8,
                    y: - 4,
                    halfExtents:
                    {
            ...
            },
            {
                ...
                link:
                {
                    href: 'https://github.com/Srivans7/Spotify---Web-Player-Clone',
                    x: - 4.8,
                    y: - 2,
                    halfExtents:
                    {
            ...
            },
            {
                ...
                link:
                {
                    href: 'https://github.com/Srivans7/Simon_Game',
                    x: - 4.8,
                    y: - 3.3,
                    halfExtents:
                    {
            ...
            },
            {
                ...
                link:
                {
                    href: 'https://github.com/Srivans7/Meal-Buddy',
                    x: - 4.8,
                    y: - 4.2,
                    halfExtents:
                    {
            ...
            },
            {
                ...
                link:
                {
                    href: 'https://github.com/Srivans7/Interview-Ease',
                    x: - 4.8,
                    y: - 3,
                    halfExtents:
                    {
            ...
            },
            {
                ...
                link:
                {
                    href: 'https://github.com/Srivans7/JavaScript_work',
                    x: - 4.8,
                    y: - 3.4,
                    halfExtents:
                    {
            ...
            },
            {
                ...
                link:
                {
                    href: 'https://github.com/Srivans7/GoFood',
                    x: - 4.8,
                    y: - 4.4,
                    halfExtents:
                    {
           ...
           
            {
                ...
                link:
                {
                    href: 'https://github.com/Srivans7/My-Portfolio',
                    x: 2.75,
                    y: - 1.1,
                    halfExtents:
                    {
